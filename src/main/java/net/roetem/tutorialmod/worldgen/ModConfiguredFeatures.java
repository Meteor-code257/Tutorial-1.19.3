package net.roetem.tutorialmod.worldgen;
...
public class ModConfiguredFeatures {
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> MAIN_BLACK_OPAL_ORE_KEY = registerKey("black_opal_ore");
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
        ...
        List<OreConfiguration.TargetBlockState> mainBlackOpalOres = List.of(
        ...
        register(context, MAIN_BLACK_OPAL_ORE_KEY, Feature.ORE,
                new OreConfiguration(mainBlackOpalOres, 6));
        register(context, NETHER_BLACK_OPAL_ORE_KEY, Feature.ORE,
                new OreConfiguration(netherrackReplaceables, ModBlocks.NETHERRACK_BLACK_OPAL_ORE.get().defaultBlockState(), 6));
        register(context, END_BLACK_OPAL_ORE_KEY, Feature.ORE,
                new OreConfiguration(endstoneReplaceables, ModBlocks.ENDSTONE_BLACK_OPAL_ORE.get().defaultBlockState(), 6));
    }
